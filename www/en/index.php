...
<html lang="en">
   ...
   <div id="leng">
             <ul class="leng">
			   <a href="index.php"><img src="en-icon.png" alt="en logo"></a>
      ...
      <nav id="head">
            <ul>
               ...
               <li><a href="php/comments.php"title="comments">comments</a></li>
               <li><a href="subfolder/about.html"title="О нас">about as</a></li>
            </ul>
         </nav>
      </div>
      <div class="container">
