<?
$db = mysql_connect ("127.0.0.1","west","west");
mysql_select_db("housephotos",$db);
...
if ($prava==5) { $com_adm=1; }	else { $com_adm=0; }
	...
	$headers.="From: WestScript.ua@WestMail\r\n";
	$headers.="X-Mailer: WestMail\r\n";
	...
	<a class='sm' target=_blank href=https://ua.linkedin.com/in/igor-maschikevich-81182a109>Скрипт разработан Igor Mashchykevych</a>
	</center>
	</body></html>";
